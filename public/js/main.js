    ...
    var rtsJs = {
        ...
        swiperActivation: function () {
            ...
            $(document).ready(function () {
                ...
                // Start autoplay when hovering over the prev button
                $('.gallery-swiper .swiper-button-prev').mouseenter(function () {
                    prevButtonInterval = setInterval(function () {
                        swiper.slidePrev();
                    }, 300); 
                });

                $('.gallery-swiper .swiper-button-next').mouseenter(function () {
                    prevButtonInterval = setInterval(function () {
                        swiper.slideNext();
                    }, 300); 
                });

                $('.gallery-swiper .swiper-button-prev').mouseleave(function () {
                    clearInterval(prevButtonInterval);
                });

                
                $('.gallery-swiper .swiper-button-next').mouseleave(function () {
                    clearInterval(prevButtonInterval);
                });
